...
//require_once(dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))))) . '/config.php');
require('../../../../../config.php');
...
<head>
    ...
    <script type="text/javascript" src="tinymce/js/nanogong.js"></script>
