...
/**
 * JS code for collapsing nav drawer nodes.
 *
 * Code is originally from https://moodle.org/plugins/local_boostnavigation.
 *
    ...
    function toggleClickHandler(node, nodename) {
        node.click(function(e) {
            ...
            if (node.attr('data-collapse') == 0) {
                ...
                M.util.set_user_preference('theme_uclashared-collapse_' + nodename + 'node', 1);
                ...
                // Save this state to the user preferences.
                M.util.set_user_preference('theme_uclashared-collapse_' + nodename + 'node', 0);
            }
        });
    }
