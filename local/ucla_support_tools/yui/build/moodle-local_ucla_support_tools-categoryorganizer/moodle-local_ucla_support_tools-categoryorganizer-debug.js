YUI.add('moodle-local_ucla_support_tools-categoryorganizer', function (Y, NAME) {
...
M.local_ucla_support_tools.categoryorganizer = {
    ...
    create_category: function () {
        Y.log('Creating new category', 'info', 'local_ucla_support_tools');
    ...
    "requires": [
        "base",
        "node",
        "moodle-local_ucla_support_tools-dialog",
        "dial",
        "slider",
        "event-valuechange",
        "color",
