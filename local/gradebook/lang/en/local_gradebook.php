...
$string['freezegradebookwarning'] = 'Recent upgrades to CCLE included an updated gradebook system. To ensure that this new system didn\'t recalculate grades that were previously posted, we have frozen them prior to the start of Fall, 2016. If you wish to recalculate the grades in this gradebook using the new system, please click on "Recalculate grades".';
$string['freezegradebookwarningbutton'] = 'Recalculate grades';
