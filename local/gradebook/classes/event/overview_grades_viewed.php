...
/**
 * The overview_grades_viewed event class.
 * 
 * Triggered when a user views the overview gradebook report.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class overview_grades_viewed extends grades_viewed {
    ...
    public static function get_name() {
        return get_string('eventgradesviewed', 'local_gradebook', 'overview');
    }
