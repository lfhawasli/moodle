...
/**
 * Event class for viewing xml grade export page.
 *
 * @since     Moodle 2.7
 * @copyright 2014 UC Regents
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class grades_export_viewed_xml extends grades_export_viewed {
    ...
    public static function get_name() {
        return get_string('eventgradesexportviewed', 'local_gradebook', 'xml');
    }
}