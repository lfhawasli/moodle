...
/**
 * Event class for exporting grades in TXT format.
 *
 * @since     Moodle 2.7
 * @copyright 2014 UC Regents
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class grades_exported_txt extends grades_exported {
    ...
    public static function get_name() {
        return get_string('eventgradesexported', 'local_gradebook', 'txt');
    }
}