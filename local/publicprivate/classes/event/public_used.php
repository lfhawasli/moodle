...
/**
 * Contains the event class for when a course module is set to public.
 *
...
/**
 * Records when a course module is set to public.
 *
 * @package    local_publicprivate
 * @copyright  2015 UC Regents
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class public_used extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpublic_used', 'local_publicprivate');
    }
    ...
    public function get_description() {
        return "User '{$this->userid}' set the module to public in course with id '{$this->courseid}'.";
    }
