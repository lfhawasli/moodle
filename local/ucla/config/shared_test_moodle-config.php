...
$CFG->forced_plugin_settings['theme_uclashared']['system_name'] = 'Shared System (TEST)';
...
$CFG->forced_plugin_settings['local_mediaconversion']['base_category_path'] = 'ccle-shared-test-kaf>site>channels';
