...
$services = array(
        ...
        'Macmillan Learning service' => array(
                'functions' => array ('local_ml_create_assignment', 'local_ml_create_external_tool', 'local_ml_get_course_lti', 'local_ml_update_grade_item_name'),
                //if set, the web service user need this capability to access
                //any function of this service. For example: 'some/capability:specified'
                // sbd TODO: define capability
                //'requiredcapability' => '',
                //if enabled, the Moodle administrator must link some user to this service
                //into the administration [sbd: I have no clue what this means.]
                'restrictedusers' => 0,
                //if enabled, the service can be reachable on a default installation
                //[sbd: I have no clue what a default installation is.]
                'enabled'=>1,
        )
);
