...
$plugin->version  = 2016082901;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->release = '0.37 (Build: 2016082901)';
$plugin->maturity = MATURITY_ALPHA; // One of: MATURITY_ALPHA, MATURITY_BETA, MATURITY_RC or MATURITY_STABLE. As far as I know, any other than MATURITY_STABLE has no side effects except a warning on install validation.
// Optional.  Allows to declare explicit dependency on other plugin(s) for this plugin to work. Moodle core checks these declared dependencies and will not allow the plugin installation and/or upgrade until all dependencies are satisfied.
