 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class syllabus_added extends syllabus_base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' added the syllabus with id '$this->objectid'";
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'course', 'syllabus added',
