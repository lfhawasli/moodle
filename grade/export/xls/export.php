...
$event = \local_gradebook\event\grades_exported_xls::create(array(
    'context' => $context,
...
// START UCLA MOD: CCLE-5599 - Add grouping filter to grade export
$export = new grade_export_xls($course, $groupid, $groupingid, $itemids, $export_feedback, $updatedgradesonly, $displaytype, $decimalpoints, $onlyactive, true);
// END UCLA MOD: CCLE-5599
$export->print_grades();
