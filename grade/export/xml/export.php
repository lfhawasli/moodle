...
$event = \local_gradebook\event\grades_exported_xml::create(array(
    'context' => $context,
...
// START UCLA MOD: CCLE-5599 - Add grouping filter to grade export
$export = new grade_export_xml($course, $groupid, $groupingid, $itemids, $export_feedback, $updatedgradesonly, $displaytype, $decimalpoints, $onlyactive);
// END UCLA MOD: CCLE-5599
$export->print_grades();
