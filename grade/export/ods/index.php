...
if ($data = $mform->get_data()) {
    ...
    $export = new grade_export_ods($course, $currentgroup, $data->grouping, '', false, false, $data->display, $data->decimals, $onlyactive, true);
...
$event = \local_gradebook\event\grades_export_viewed_ods::create(array(
    'context' => $context,
