...
/**
 * The mod_qanda entry updated event.
 *
 * @package    mod_qanda
...
/**
 * The mod_qanda entry updated event class.
 *
 * @package    mod_qanda
 * @copyright  2014 UC Regents
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class entry_updated extends \core\event\base {
    ...
    */
    public static function get_name() {
        return get_string('evententryupdated', 'qanda');
    }
    /**
    ...
    */
    public function get_description() {
        return "The user with id '$this->userid' has updated the qanda entry with id '$this->objectid'.";
    }
    /**
    ...
    */
    public function get_legacy_logdata() {
        return array($this->courseid, 'qanda', 'update entry', 
