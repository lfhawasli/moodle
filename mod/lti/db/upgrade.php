...
function xmldb_lti_upgrade($oldversion) {
    ...
    if ($oldversion < 2020042404) {
        ...
        upgrade_mod_savepoint(true, 2020042404, 'lti');
    }

    if ($oldversion < 2020042405) {
        ...
        upgrade_mod_savepoint(true, 2020042405, 'lti');
    }

    if ($oldversion < 2020042406) {
        ...
        upgrade_mod_savepoint(true, 2020042406, 'lti');
    }

    if ($oldversion < 2020042407) {
        $table = new xmldb_table('lti_types');
        ...
        upgrade_mod_savepoint(true, 2020042407, 'lti');
    }
