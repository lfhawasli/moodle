...
/**
 * Strings for component 'assignsubmission_usqfiletypes', language 'en'
 *
...
$string['enabled'] = 'File type filtering';
$string['enabled_help'] = 'If enabled, file types that students are able to upload as their submission will be restricted to those specified.';
...
$string['pluginname'] = 'File type filtering';
$string['usqfiletypes'] = 'Accepted file types';
