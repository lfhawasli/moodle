 ...
 *
 * Class for event to be triggered when an invitation is claimed.
 *
 * @package    enrol_invitation
 * @copyright  2014 UC Regents
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class invitation_claimed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinvitationclaimed', 'enrol_invitation');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has claimed the invitation with enrol_invitation id '{$this->objectid}'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'enrol_invitation', 'invitation claim', $logurl, $this->other);
    }
}
