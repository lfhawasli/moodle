...
/**
 * Invitation viewed event class.
 *
 * Class for event to be triggered when a user view the course invitation.
 *
 * @package    enrol_invitation
...
class invitation_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinvitationviewed', 'enrol_invitation');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has viewed the invitation with enrol_invitation id '{$this->objectid}'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'enrol_invitation', 'invitation view', $logurl, $this->other);
    }
}
