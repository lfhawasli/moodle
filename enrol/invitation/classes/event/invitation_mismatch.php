 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class invitation_mismatch extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinvitationmismatch', 'enrol_invitation');
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'enrol_invitation', 'invitation mismatch', $logurl, $this->other);
    }
}
