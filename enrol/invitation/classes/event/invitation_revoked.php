...
/**
 * Invitation revoked event class.
 *
 * Class for event to be triggered when the invitation is revoked.
 *
 * @package    enrol_invitation
...
class invitation_revoked extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinvitationrevoked', 'enrol_invitation');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has revoked an invitation with enrol_invitation id '{$this->objectid}'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'enrol_invitation', 'invitation revoke', $logurl, $this->other);
    }
}
