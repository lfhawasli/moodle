...
/**
 * Invitation sent event class.
 *
 * Class for event to be triggered when an invitation is sent.
 *
 * @package    enrol_invitation
...
class invitation_sent extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinvitationsent', 'enrol_invitation');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has sent an invitation with enrol_invitation id '{$this->objectid}'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'enrol_invitation', 'invitation send', $logurl, $this->other);
    }
}
