 ...
 *
 * Class for event to be triggered when an invitation is re-sent.
 *
 * @package    enrol_invitation
 * @copyright  2014 UC Regents
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class invitation_extended extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventinvitationextended', 'enrol_invitation');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' has extended an invitation with enrol_invitation id '{$this->objectid}'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'enrol_invitation', 'invitation extend', $logurl, $this->other);
    }
}
