...
$string['bysectionchoice'] = 'Sec {$a->sec} (TAs - {$a->tas})';
...
$string['succhangedgroupingpp'] = 'Default grouping changed. Now all the students in the course may access {$a}';
$string['succhangedgroupingta'] = 'Default grouping changed. Now only students enrolled in the TA\'s sections may access {$a}';
