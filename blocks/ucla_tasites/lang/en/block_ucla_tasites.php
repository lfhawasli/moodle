...
$string['succhangedgroupingpp'] = 'Accessiblity changed. Now all the students in the course may access {$a}';
$string['succhangedgroupingta'] = 'Accessiblity changed. Now only students enrolled in the TA\'s sections may access {$a}';
