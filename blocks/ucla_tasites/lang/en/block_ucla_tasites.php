...
$string['bytachoice'] = '{$a->fullname} (TA for Sec {$a->sections})';
$string['bytadesc'] = 'For which TA do you want to create a TA site?';
$string['bytaentirecourse'] = 'Make TA site available for entire course, rather than just their sections';
...
$string['listaccessiblecourse'] = 'Accessible to: Entire course';
$string['listaccessiblesections'] = 'Accessible to: Students only in sections {$a}';
...
$string['succhangedgroupingpp'] = 'Accessiblity changed. Now <b>ALL</b> the students in the course may access {$a}';
$string['succhangedgroupingta'] = 'Accessiblity changed. Now <b>ONLY</b> students enrolled in the TA\'s sections may access {$a}';
