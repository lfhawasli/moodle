<?php
$string['pluginname'] = 'UCLA bruinmedia';
$string['title'] = 'Bruinmedia';
...
$string['errornotify_email_desc'] = 'Email for notification of Bruinmedia parsing errors';

// Types of bruinmedias
