...
/**
 * Request created event class.
 * 
 * Class for event to be triggered when a user makes a course download request.
 *
 * @package    block_ucla_course_download
 * @copyright  2014 UC Regents
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class request_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrequestcreated', 'block_ucla_course_download');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' created a course download request with ucla_archives id '{$this->objectid}'.";
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'course', 'ucla archive request', $logurl);
    }
}
