...
Scenario: Upload same file twice and copyright status drop down only show once for the two files
    ...
    And I follow "Manage copyright"
    And I set the field "filter_copyright" to "All"
    And I should see "Test file1" in the "//tr[contains(@class, 'r0')]/descendant::td[contains(@class, 'c0')]" "xpath_element"
    And I should see "Test file2" in the "//tr[contains(@class, 'r0')]/descendant::td[contains(@class, 'c0')]" "xpath_element"
    And "//tr[contains(@class, 'r0')]/descendant::td[contains(@class, 'c0')]/descendant::select[contains(@name,'filecopyright_')]" "xpath_element" should exist
