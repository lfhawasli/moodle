...
Scenario: Copyright Status: "I own the copyright" works
    ...
    And "//option[@value='iown' and @selected='selected']" "xpath_element" should exists
...
Scenario: Copyright Status: "The UC Regents own the copyright" works
    ...
    And I press "Save changes"
    And "//option[@value='ucown' and @selected='selected']" "xpath_element" should exists
...
Scenario: Copyright Status: "Item is licensed by the UCLA Library" works
    ...
    And I press "Save changes"
    And "//option[@value='lib' and @selected='selected']" "xpath_element" should exists
...
Scenario: Copyright Status: "Item is in the public domain" works
    ...
    And I press "Save changes"
    And "//option[@value='public1' and @selected='selected']" "xpath_element" should exists
...
Scenario: Copyright Status: "Item is available for this use via Creative Commons license" works
    ...
    And I press "Save changes"
    And "//option[@value='cc1' and @selected='selected']" "xpath_element" should exists
...
Scenario: Copyright Status: "I have obtained written permission from the copyright holder" works
    ...
    And I press "Save changes"
    And "//option[@value='obtained' and @selected='selected']" "xpath_element" should exists
...
Scenario: Copyright Status: "I am using this item under fair use" works
    ...
    And I press "Save changes"
    And "//option[@value='fairuse' and @selected='selected']" "xpath_element" should exists
...
Scenario: Copyright Status: "Copyright status not yet identified" works
    ...
    And I press "Save changes"
    And "//option[@value='tbd' and @selected='selected']" "xpath_element" should exists