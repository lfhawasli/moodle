 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class video_reserves_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventvidreserveviewed', 'block_ucla_media');
    }

    /**
     * Returns info on when a user with ID has viewed the video reserve file.
     *
     * @return string
     */
    public function get_description() {
        return "The user with id '{$this->userid}' viewed the video reserve "
            . "'{$this->other['name']}'.";
    }

    /**
     * Returns URL to video reserves video viewed.
     *
     * @return \moodle_url
     */
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'course', 'video reserves view',
