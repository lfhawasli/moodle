...
$header = format_string($course->shortname).": $mediagallery";

$PAGE->navbar->add(get_string('nav_mediagallery', 'local_kalturamediagallery'));

$PAGE->set_url('/blocks/ucla_media/kalvidres.php', array('courseid' => $courseid));
...
echo $OUTPUT->header();
print_media_page_tabs($mediagallery, $course->id);
...
$attr = array(
    ...
    'src' => '/local/kalturamediagallery/lti_launch.php?courseid='.$courseid
);
