...
$string['syllabuswebservice'] = 'Manually push syllabus information';
...
$string['choose_division'] = 'Choose division...';
...
$string['paginatedxresults'] = 'Showing {$a->pagerange1}-{$a->pagerange2} entries from {$a->totalcount} total results';
